/// <summary>
/// Page Farah Customer Rewards Wizard (ID 50903).
/// </summary>
page 50904 "Farah Customer Rewards Wizard"
{
    ...
    actions
    {
        area(Processing)
        {
            ...
            action(ActionActivate)
            {
                ...
                trigger OnAction();
                var
                    CustomerRewardsExtMgt: Codeunit "Farah Cust Rewards Ext. Mgt.";
                begin
    ...
    begin
        ...
        AssistedSetup.Complete(PAGE::"Farah Customer Rewards Wizard");
        CurrPage.Close;
